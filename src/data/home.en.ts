...
export const trainers: { id: string; name: string; role: string; media: string; bio: string; bioShort?: string }[] = [
  ...
  { id: 'eliska-velazquez', name: 'Eliška Velázquez', role: 'Instructor · Kids Zumba', media: 'media-forest', bioShort: 'Eliška fell in love with Zumba during university in 2017 and has held a Zumba® and Zumba® Kids & Kids Jr. instructor licence since 2022. At BoHeMi she leads Kids Zumba.', bio: 'Eliška fell in love with Zumba during university in 2017. She has held a Zumba® and Zumba® Kids & Kids Jr. instructor licence since 2022 (active ZIN member), and an Aqua Zumba® licence since 2025. She has taught in Germany (Dortmund, Wiesbaden) and in Czechia, and has worked with children since 2016 — as a camp leader, outdoor-school instructor and au pair. At BoHeMi she leads Kids Zumba.' },
...
// 199 CZK strength classes, 250 CZK Enduro/Discovery Room, 150 CZK Open gym.
export const pricing = [
  { t: 'Single entry', d: 'When you come just occasionally', price: '199 CZK', per: '/ class', featured: false, badge: '', note: 'Price varies by class type.', feat: ['Circuit, strength, HIIT, Supermums – 199 CZK', 'Enduro, Discovery Room – 250 CZK · Open gym – 150 CZK', 'Pay per class separately, no discount'] },
