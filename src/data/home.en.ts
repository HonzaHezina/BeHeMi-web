...
// bio = full text, CS-only /treneri/ detail. bioShort = HP teaser version
// (Trainers.astro) — same teaser/detail split as home.ts.
export const trainers: { id: string; name: string; role: string; media: string; bio: string; bioShort?: string }[] = [
  { id: 'klara-mechurova', name: 'Klára Měchurová', role: 'Coach · functional training', media: 'media-green', bioShort: 'Klára has been active since childhood — ballet, tennis, basketball, dance. She leads circuit, strength and HIIT classes and offers personal training.', bio: 'Klára has been active since childhood — ballet, tennis, basketball, dance. Certified fitness instructor since 2015, active since 2013. She leads circuit, strength and HIIT classes and offers personal training.' },
  { id: 'jitka-stepankova', name: 'Jitka Štěpánková', role: 'Instructor · Power Zone', media: 'media-sand', bioShort: 'Jitka specialises in CrossFit, weightlifting, functional training and HIIT. Her classes are varied, dynamic and never the same twice.', bio: 'Jitka specialises in CrossFit, weightlifting, functional training and HIIT. Her classes are varied, dynamic and never the same twice — she builds an environment where people support each other and build a team spirit. Whether you\'re a beginner or an experienced athlete, you\'ll work together on making training enjoyable and effective.' },
  { id: 'eliska-velazquez', name: 'Eliška Velázquez', role: 'Instructor · Zumba and Kids Zumba', media: 'media-forest', bioShort: 'Eliška fell in love with Zumba during university in 2017 and has held a Zumba® and Zumba® Kids & Kids Jr. instructor licence since 2022. At BoHeMi she leads Zumba for adults and Kids Zumba.', bio: 'Eliška fell in love with Zumba during university in 2017. She has held a Zumba® and Zumba® Kids & Kids Jr. instructor licence since 2022 (active ZIN member), and an Aqua Zumba® licence since 2025. She has taught in Germany (Dortmund, Wiesbaden) and in Czechia, and has worked with children since 2016 — as a camp leader, outdoor-school instructor and au pair. At BoHeMi she leads Zumba for adults and Kids Zumba.' },
  { id: 'jan-hezina', name: 'Jan Hezina', role: 'founder · operations & tech', media: 'media-clay', bioShort: 'BoHeMi grew out of Honza\'s own experience that movement changes more than your body — circuit training taught him to see things through, juggling taught him focus and patience. Today he holds the overall direction and looks after AI, tech and operations.', bio: 'BoHeMi grew out of Honza\'s own experience that movement changes more than your body. He\'s spent his whole career in IT, working in artificial intelligence — he likes systems and how things fit together. Once he started moving regularly, it clicked that the body is a system too: circuit training taught him to see things through to the end, juggling taught him focus, patience and the ability to read patterns — and that this carried over into work and everyday life. Over time he found a more complete framework that confirmed what he already knew from experience — that the body, habits, mind and relationships connect more than people usually assume. From that he shaped what BoHeMi should be. He set the direction; Klára added the coaching and instruction side and got classes running. Today Honza holds the overall direction and looks after AI, tech and operations.' },
];
...
// Single entry price varies by class type (confirmed by Klárka 1 Aug 2026):
// 199 CZK strength classes, 250 CZK Zumba/Enduro/Discovery Room, 150 CZK Open gym.
export const pricing = [
  { t: 'Single entry', d: 'When you come just occasionally', price: '199 CZK', per: '/ class', featured: false, badge: '', note: 'Price varies by class type.', feat: ['Circuit, strength, HIIT, Supermums – 199 CZK', 'Zumba, Enduro, Discovery Room – 250 CZK · Open gym – 150 CZK', 'Pay per class separately, no discount'] },
...
export const navMenu = [
  ...
  { num: '03', label: 'Courses', desc: 'Calisthenics, juggling, handstands', href: '/kurzy/' },
