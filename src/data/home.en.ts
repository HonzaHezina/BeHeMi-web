...
export const approach = [
  ...
  { n: '06', t: 'I want to train as a mum', d: 'Supermums are classes you can attend with your child. Training adapts to the reality of parenting.' },
  { n: '07', t: 'I want movement for my kids', d: 'Circus School, acrobatics, and movement clubs led by experienced coaches. Movement through play.' },
  { n: '08', t: 'I want a movement program for my team', d: 'FitTeams — coached circuit training designed specifically for company groups. No gym required.' },
];
...
export const audiences = [
  ...
  { fig: '02', tagline: 'Kids & families', label: 'For kids & families', d: "Movement for the youngest and for parents who don't want to stop.", items: ['Circus School', 'Movement clubs & acrobatics', 'Supermums — babies welcome', 'Summer camps'], anchor: '#pro-deti' },
...
export const paths = [
  { tag: 'flagship', t: '8-Week Program', d: 'Eight weeks with a small group — not a punch card.' },
  ...
  { tag: 'group', t: 'Mums', d: 'Movement for mums — babies welcome beside you.' },
