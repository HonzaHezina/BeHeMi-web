...
export const classes: { id: string; t: string; d: string; img: string; media: string; bhm: string; page?: string }[] = [
  ...
  // Move Smart sits at position 7 ON PURPOSE — homepage and hub show
  // classes.slice(0, 6) and the approved six (5 Jul 2026) must not change.
  { id: 'move-smart', t: 'Move Smart', d: 'A slower-paced class built on natural movement patterns and core activation. Technique first — for beginners, new mums, and anyone with back pain from sitting.', img: 'move smart', media: 'media-forest', bhm: 'Body · technique · control' },
