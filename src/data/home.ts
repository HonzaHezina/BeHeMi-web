...
export const trainers: { id: string; name: string; role: string; media: string; bio: string; bioShort?: string }[] = [
  ...
  { id: 'eliska-velazquez', name: 'Eliška Velázquez', role: 'Lektorka · Zumba a Dětská Zumba', media: 'media-forest', bioShort: 'Eliška se Zumbě věnuje od roku 2017 a má licenci instruktorky Zumba® i Zumba® Kids & Kids Jr. V BoHeMi vede Zumbu pro dospělé i Dětskou Zumbu.', bio: 'Eliška se Zumbě věnuje od roku 2017, kdy se k ní dostala během vysoké školy. Od roku 2022 má licenci instruktorky Zumba® a Zumba® Kids & Kids Jr. (aktivní ZIN členství), od roku 2025 i Aqua Zumba®. Lekce vedla v Německu (Dortmund, Wiesbaden) i v Česku, s dětmi pracuje od roku 2016 — jako vedoucí na táborech, instruktorka škol v přírodě i au pair. V BoHeMi vede Zumbu pro dospělé i Dětskou Zumbu.' },
