...
export const ui = {
  cs: {
    ...
    footer_hours_label: 'Otevírací doba',
    footer_hours_value: 'Po — Pá: dle rozvrhu',
    footer_map: 'Zobrazit na mapě →',
    footer_legal_terms: 'Obchodní podmínky',
  ...
  en: {
    ...
    footer_hours_value: 'Mon — Fri: per class schedule',
